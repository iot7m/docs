...
* xref:aqara-{page-locale}.adoc[*Aqara*] – voice control of the Aqara ecosystem via a Zigbee gateway.
* xref:xiaomi-{page-locale}.adoc[*Xiaomi*] – control of Xiaomi sensors and devices through Home Assistant.
